...
public class LevelTypeInfor
{
    ...
    public Sprite GetBoosterSprite(EElementType getElementType) =>
        boosterIconDatas.FirstOrDefault(b => b.elementType == getElementType).icon;

    public Sprite GetBoosterSpriteLock(EElementType getElementType) =>
        boosterIconDatas.FirstOrDefault(b => b.elementType == getElementType).iconLock;
