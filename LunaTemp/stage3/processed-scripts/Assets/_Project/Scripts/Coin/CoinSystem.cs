...
public class CoinSystem : MonoBehaviour
{
    ...
    private void InternalSetCoin(int value, [Bridge.Ref] Vector3 posGenerateCoin, TrackingEnum.EResourceType resourceType,
    ...
    private void InternalAddCoin(int value, [Bridge.Ref] Vector3 posGenerateCoin, TrackingEnum.EResourceType resourceType, TrackingEnum.EResourceName resourceName,
