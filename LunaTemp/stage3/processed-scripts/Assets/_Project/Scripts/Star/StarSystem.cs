...
public class StarSystem : MonoBehaviour
{
    ...
    private void InternalSetStar(int value, [Bridge.Ref] Vector3 posGenerateCoin, TrackingEnum.EResourceType resourceType,
        TrackingEnum.EResourceName resourceName, TrackingEnum.EResourceReason resourceReason, TrackingEnum.EPlacement placement)
    {
        if (value > CurrentStar)
        {
            ...
            if (posGenerateCoin != default(UnityEngine.Vector3))
            {
    ...
    private void InternalAddStar(int value, [Bridge.Ref] Vector3 posGenerateCoin, TrackingEnum.EResourceType resourceType, TrackingEnum.EResourceName resourceName,
