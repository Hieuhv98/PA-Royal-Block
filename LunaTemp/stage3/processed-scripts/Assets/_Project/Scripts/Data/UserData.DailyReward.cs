...
namespace TheBeginning.Data
{
    public partial struct UserData
    {
        ...
        public static string LastDailyMainGiftClaimed
        {
            get => Get(Constant.LAST_DAILY_GIFT_CLAIM, DateTime.Now.ToString());
            set => Set(Constant.LAST_DAILY_GIFT_CLAIM, value);
        }

        public static string LastDailyGift
        {
            get => Get(Constant.LAST_DAILY_GIFT, DateTime.Now.ToString());
            set => Set(Constant.LAST_DAILY_GIFT, value);
        }

        public static string LastDailyInfinity
        {
            get => Get(Constant.LAST_DAILY_INFINITY, DateTime.Now.ToString());
            set => Set(Constant.LAST_DAILY_INFINITY, value);
        }
