...
public abstract class ObjectBase : BaseMono, IObject, IFreezer
{
    ...
    public float GetWidth(EDirectionType eDirection, [Bridge.Ref] Vector2 size)
    {
    ...
    public float GetHeight(EDirectionType eDirection, [Bridge.Ref] Vector2 size)
    {
        return eDirection switch
        {
    ...
    public void SetPosition([Bridge.Ref] Vector3 position)
    {
