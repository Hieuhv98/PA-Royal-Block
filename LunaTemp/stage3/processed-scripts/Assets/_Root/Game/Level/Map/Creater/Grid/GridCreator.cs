...
{
    public GridSystem Create(Transform parent, GridType gridType, AxisType axisType, GridSetting setting, [Bridge.Ref] Vector2 size, bool createAsPrefab, [Bridge.Ref] Vector2 sizeActive)
    {
    ...
    private bool CanSpawn(GridType type, [Bridge.Ref] Vector2Int coordinate)
    {
