...
public static partial class Extension
{
    ...
    public static Vector3 WorldToCanvasPosition(Camera camera, Canvas canvas, [Bridge.Ref] Vector3 position)
    {
    ...
    public static Sequence FlyToTarget(this RectTransform target, Vector3 endValue, float durationFlightUp,
        ...
        float widthRange, Action complete, Vector3 scaleEnd = default(UnityEngine.Vector3))
    {
