...
namespace VirtueSky.ObjectPooling
{
    internal sealed class PoolHandle
    {
        ...
        internal void DeSpawn<T>(T type, bool destroy = false, bool worldPositionStays = true) where T : UnityEngine.Component
        {
        ...
        internal T Spawn<T>(T type, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation, Transform parent = null,
        ...
        internal GameObject Spawn(GameObject prefab, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation, Transform parent = null,
